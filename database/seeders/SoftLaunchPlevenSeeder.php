    ...
    public function run(): void
    {
        $executors = collect([
            [
                ...
                'service_categories' => ['Ремонти и строителство', 'Ремонт на бани'],
                ...
                'services' => [
                    ['title' => 'Ремонт на баня', 'category' => 'Ремонт на бани', 'price' => 1200],
            ...
            [
                ...
                'short_description' => 'ВиК ремонти, течове, бойлери, сифони и аварийни посещения.',
                'description' => 'Контролиран soft-launch профил за ВиК услуги в Плевен. Подходящ за проверка на заявки, matching по град и категория и публични профили.',
                'service_areas' => 'Плевен, Долна Митрополия, Буковлък',
                'service_cities' => ['Плевен', 'Долна Митрополия'],
                'service_categories' => ['ВиК услуги', 'Откриване на течове'],
                ...
                'services' => [
                    ['title' => 'Отстраняване на теч', 'category' => 'ВиК услуги', 'price' => 45],
                    ['title' => 'Монтаж на бойлер', 'category' => 'ВиК услуги', 'price' => 85],
                ],
            ],
            [
                ...
                'service_categories' => ['Електроуслуги', 'Спешни домашни услуги'],
                ...
                'offer_points_balance' => 90,
                'services' => [
                    ['title' => 'Смяна на електро табло', 'category' => 'Електроуслуги', 'price' => 180],
                    ['title' => 'Монтаж на осветление', 'category' => 'Електроуслуги', 'price' => 60],
                ],
            ],
            [
                ...
                'services' => [
                    ['title' => 'Почистване след ремонт', 'category' => 'Почистване след ремонт', 'price' => 120],
            ...
            [
                ...
                'service_categories' => ['Климатици и отопление', 'Ремонт на техника'],
                'payment_methods' => 'В брой, банков превод',
                ...
                'offer_points_balance' => 30,
                'services' => [
                    ['title' => 'Профилактика на климатик', 'category' => 'Климатици и отопление', 'price' => 55],
                    ['title' => 'Монтаж на климатик', 'category' => 'Климатици и отопление', 'price' => 180],
                ],
            ],
        ]);
