    ...
    <main class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <section class="mt-6 grid gap-4 lg:grid-cols-2">
            <article class="rounded-[32px] border border-orange-300/20 bg-orange-300/10 p-6 shadow-xl shadow-black/20 backdrop-blur-xl sm:p-8">
                ...
                <a href="{{ route('request.service') }}" class="mt-5 inline-flex min-h-12 items-center justify-center rounded-2xl bg-gradient-to-r from-orange-500 via-amber-400 to-orange-600 px-6 py-4 font-black text-white">Заяви оферта</a>
            </article>
            ...
            <article class="rounded-[32px] border border-orange-300/20 bg-orange-400/10 p-6 shadow-xl shadow-black/20 backdrop-blur-xl sm:p-8">
                <p class="text-sm font-black uppercase tracking-[0.22em] text-orange-100">За изпълнители</p>
