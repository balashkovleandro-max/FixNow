@php
    ...
    $itemIdle = 'text-slate-400 hover:bg-white/10 hover:text-white';
    $itemActive = 'bg-white/10 text-white shadow-[0_0_24px_rgba(124,58,237,0.18)]';
    $isHome = request()->path() === '/';
@endphp

<nav class="fixed inset-x-0 bottom-0 z-[70] border-t border-white/10 bg-slate-950/90 px-2 pt-2 shadow-[0_-18px_48px_rgba(0,0,0,0.25)] backdrop-blur-2xl md:hidden" style="padding-bottom: max(0.55rem, env(safe-area-inset-bottom));" aria-label="Мобилна навигация">
