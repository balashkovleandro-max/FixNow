<header class="sticky top-0 z-50 border-b border-white/50 bg-[#F8FAFF]/85 backdrop-blur-2xl">
    <div class="mx-auto flex h-16 max-w-[1480px] items-center justify-between px-4 sm:h-20 sm:px-6 lg:px-10">
        ...
        <nav class="hidden items-center gap-2 lg:flex" aria-label="Основна навигация">
            ...
            <a href="{{ route('search') }}" class="rounded-2xl px-4 py-2.5 text-sm font-bold text-slate-600 transition hover:bg-white/70 hover:text-blue-600">Търсене</a>
            ...
            <a href="{{ route('freelancer.projects.index') }}" class="rounded-2xl px-4 py-2.5 text-sm font-bold text-slate-600 transition hover:bg-white/70 hover:text-blue-600">Проекти</a>
        ...
        <div class="hidden items-center gap-3 md:flex">
            @guest
                <a href="{{ route('login') }}" onclick="window.trackBonEvent('login_start', { source: 'header' })" class="rounded-2xl border border-slate-200/80 bg-white/70 px-5 py-3 text-sm font-black text-[#070B1F] shadow-sm transition hover:border-blue-200 hover:text-blue-600">
                    Вход
                </a>
        ...
        <details class="group relative md:hidden">
            ...
            <div class="absolute right-0 top-12 max-h-[calc(100dvh-5rem)] w-[min(21rem,calc(100vw-2rem))] overflow-y-auto rounded-[1.75rem] border border-white/70 bg-white/90 p-3 shadow-2xl shadow-blue-900/10 backdrop-blur-2xl sm:top-14">
                <div class="grid gap-1">
                    ...
                    <a href="{{ route('search') }}" class="rounded-2xl px-4 py-3 text-sm font-black text-slate-600 hover:bg-blue-50 hover:text-blue-700">Търсене</a>
                    ...
                    <a href="{{ route('freelancer.projects.index') }}" class="rounded-2xl px-4 py-3 text-sm font-black text-slate-600 hover:bg-blue-50 hover:text-blue-700">Проекти</a>
