...
<head>
    ...
    <meta name="description" content="Свържете се с BON за въпроси за бизнес профили, видимост, доверие, партньорства и поддръжка.">
    <title>Контакт | BON</title>
...
<body class="fn-premium-page min-h-screen overflow-x-hidden pb-24 text-white md:pb-0">
    @php
        $contactEmail = config('mail.from.address') ?: 'hello@bon.bg';
    @endphp
...
<main class="mx-auto grid max-w-7xl items-start gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1fr_520px] lg:px-8">
        <section class="pt-4 lg:pt-12">
            ...
            <p class="mt-6 max-w-xl text-lg leading-8 text-white/70">
                Пишете ни за бизнес профил, видимост, доверие, партньорство, проблем с акаунт или идея за развитие на BON.
            </p>
            ...
            <div class="mt-8 grid gap-4 sm:grid-cols-2">
                <a href="{{ route('business.landing') }}" class="rounded-3xl border border-white/10 bg-white/10 p-5 shadow-xl shadow-black/20 backdrop-blur-xl hover:border-orange-300/30">
                    <p class="text-sm font-black text-orange-100">За бизнеси</p>
                    <h2 class="mt-2 text-xl font-black">Добавете профил</h2>
                    <p class="mt-2 text-sm leading-6 text-white/60">Вижте как BON може да носи повече видимост, доверие и професионално представяне.</p>
                </a>
                <a href="{{ route('businesses.index') }}" class="rounded-3xl border border-white/10 bg-white/10 p-5 shadow-xl shadow-black/20 backdrop-blur-xl hover:border-orange-300/30">
                    <p class="text-sm font-black text-orange-100">За клиенти</p>
                    <h2 class="mt-2 text-xl font-black">Намерете доверен профил</h2>
                    <p class="mt-2 text-sm leading-6 text-white/60">Разгледайте добре представени бизнеси по категория, град, отзиви и доверителни сигнали.</p>
                </a>
            </div>
        </section>
        ...
        <section class="rounded-[32px] border border-white/10 bg-white/10 p-6 shadow-2xl shadow-black/25 backdrop-blur-2xl sm:p-8 lg:mt-12">
            ...
            <div class="mt-6 grid gap-4">
                <a href="mailto:{{ $contactEmail }}" class="block rounded-3xl border border-white/10 bg-slate-950/50 p-5 hover:bg-white/10">
                    ...
                    <p class="mt-2 text-sm leading-6 text-white/55">За партньорства, профили на бизнеси, правни въпроси и поддръжка.</p>
                </a>
                ...
                <div class="rounded-3xl border border-white/10 bg-slate-950/50 p-5">
                    ...
                    <p class="mt-2 text-sm leading-6 text-white/60">За бизнес присъствие, планове, профили и партньорства пишете директно на екипа на BON.</p>
                </div>

                <div class="grid gap-3 sm:grid-cols-2">
                    <a href="{{ route('businesses.index') }}" class="inline-flex min-h-12 items-center justify-center rounded-2xl bg-gradient-to-r from-orange-500 via-amber-400 to-orange-600 px-6 py-4 text-center font-black text-white">
                        Виж бизнеси
                    </a>
