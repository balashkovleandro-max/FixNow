        ...
        <section class="mt-6 grid gap-5">
            @foreach([
                ...
                [
                    ...
                    'body' => 'Платените планове Standard и Premium се управляват чрез Stripe. Абонаментът се активира след успешно плащане и потвърждение от Stripe webhook. Потребителят може да управлява абонамента си през billing страницата и Stripe Customer Portal, когато е наличен.'
                ],
                [
