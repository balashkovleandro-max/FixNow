...
<body class="min-h-screen bg-[#020812] pb-24 text-white md:pb-0">
    ...
    <header class="sticky top-0 z-50 border-b border-white/10 bg-[#030712]/85 backdrop-blur-2xl">
        <div class="mx-auto flex max-w-[1500px] items-center justify-between px-4 py-4 sm:px-6 lg:px-12">
            ...
            <nav class="hidden items-center gap-6 lg:flex">
                ...
                <a href="{{ route('request.service') }}" class="text-sm font-semibold text-cyan-200 hover:text-cyan-100">Заяви оферта</a>
