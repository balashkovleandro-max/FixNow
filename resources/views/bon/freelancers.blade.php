...
<body class="bon-dark-page antialiased">
    <main class="relative min-h-screen overflow-x-clip text-white">
        ...
        <div class="relative z-10">
            ...
            <section class="mx-auto max-w-[1440px] px-4 pb-5 pt-6 sm:px-6 sm:pb-8 sm:pt-10 lg:px-8">
                <nav class="flex gap-2 overflow-x-auto rounded-[1.5rem] border border-white/70 bg-white/75 p-2 text-sm font-black shadow-xl shadow-blue-900/5 backdrop-blur-2xl sm:flex-wrap sm:justify-center sm:rounded-[2rem]" aria-label="Freelance навигация">
                    <a href="#freelancer-directory" class="min-w-max rounded-2xl px-4 py-3 text-slate-700 hover:bg-blue-50 hover:text-blue-700">Намери фрилансър</a>
                    <a href="{{ route('freelancer.projects.create') }}" class="min-w-max rounded-2xl px-4 py-3 text-slate-700 hover:bg-blue-50 hover:text-blue-700">Публикувай проект</a>
                    ...
                    <a href="#how-freelance-works" class="min-w-max rounded-2xl px-4 py-3 text-slate-700 hover:bg-blue-50 hover:text-blue-700">Как работи</a>
                </nav>
            </section>

            <section class="mx-auto grid max-w-[1440px] gap-7 px-4 py-6 sm:px-6 sm:py-12 lg:grid-cols-[1fr_0.9fr] lg:items-center lg:px-8 lg:py-16">
                <div>
                    ...
                    <h1 class="mt-5 max-w-4xl text-[32px] font-black leading-tight tracking-tight sm:text-6xl">
                    ...
                    <p class="mt-5 max-w-3xl text-[15px] leading-7 text-slate-600 sm:text-lg sm:leading-8">
                    ...
                    <div class="mt-6 flex flex-col gap-3 sm:flex-row">
                        ...
                        <a href="{{ route('freelancer.projects.index') }}" class="inline-flex min-h-12 w-full items-center justify-center rounded-2xl border border-slate-200/80 bg-white/75 px-6 text-sm font-black text-slate-700 shadow-sm transition hover:-translate-y-0.5 hover:border-blue-200 hover:text-blue-600 sm:w-auto">
                            Виж проекти
                        </a>
                        <a href="#freelancer-directory" class="inline-flex min-h-12 w-full items-center justify-center rounded-2xl border border-violet-200/80 bg-violet-50/75 px-6 text-sm font-black text-violet-700 shadow-sm transition hover:-translate-y-0.5 sm:w-auto">
                            Намери фрилансър
                        </a>
                    </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative rounded-[1.5rem] border border-white/70 bg-white/78 p-5 shadow-2xl shadow-blue-900/10 backdrop-blur-2xl sm:rounded-[2rem] sm:p-8">
            ...
            <section id="how-freelance-works" class="mx-auto max-w-[1440px] px-4 py-5 sm:px-6 sm:py-8 lg:px-8">
                <div class="rounded-[1.5rem] border border-white/70 bg-white/76 p-5 shadow-2xl shadow-blue-900/5 backdrop-blur-2xl sm:rounded-[2rem] sm:p-8">
                    <p class="text-sm font-black uppercase tracking-[0.22em] text-blue-600">Как работи</p>
                    <h2 class="mt-3 text-[26px] font-black leading-tight tracking-tight sm:text-5xl">
            ...
            <section class="mx-auto grid max-w-[1440px] gap-5 px-4 py-5 sm:gap-6 sm:px-6 sm:py-8 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
                <div class="rounded-[1.5rem] border border-white/70 bg-white/76 p-5 shadow-2xl shadow-blue-900/5 backdrop-blur-2xl sm:rounded-[2rem] sm:p-8">
                    <p class="text-sm font-black uppercase tracking-[0.22em] text-fuchsia-600">Защо си струва</p>
                    <h2 class="mt-3 text-[24px] font-black leading-tight tracking-tight sm:text-3xl">За специалисти, които искат да изглеждат сериозно онлайн.</h2>
                    <div class="mt-7 grid gap-3">
                ...
                <div class="rounded-[1.5rem] border border-white/70 bg-white/76 p-5 shadow-2xl shadow-blue-900/5 backdrop-blur-2xl sm:rounded-[2rem] sm:p-8">
                    ...
                    <h2 class="mt-3 text-[24px] font-black leading-tight tracking-tight sm:text-3xl">Покажи експертизата си ясно.</h2>
                    <div class="mt-6 flex flex-wrap gap-2.5 sm:gap-3">
                        @foreach ($categories as $category)
                            <span class="rounded-full border border-white/80 bg-white/80 px-4 py-2 text-sm font-black text-slate-700 shadow-sm">
                                {{ $category }}
                            </span>
                        @endforeach
                    </div>
            ...
            <section id="freelancer-directory" class="mx-auto max-w-[1440px] px-4 py-5 sm:px-6 sm:py-8 lg:px-8">
                <div class="rounded-[1.5rem] border border-white/70 bg-white/78 p-5 shadow-2xl shadow-blue-900/5 backdrop-blur-2xl sm:rounded-[2rem] sm:p-8">
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                        <div>
                            <p class="text-sm font-black uppercase tracking-[0.22em] text-blue-600">Намери фрилансър</p>
                            <h2 class="mt-3 text-[26px] font-black leading-tight tracking-tight sm:text-5xl">Специалисти в BON</h2>
                    ...
                    <form method="GET" action="{{ route('bon.freelancers') }}" class="mt-7 grid gap-3 lg:grid-cols-[1fr_180px_160px_160px_150px_150px_auto]">
                        <input name="q" value="{{ request('q') }}" placeholder="Име, умение, услуга..." class="min-h-12 rounded-2xl border border-slate-200 bg-white/85 px-4 text-sm outline-none focus:border-blue-300 focus:ring-4 focus:ring-blue-100">
                        <input name="category" list="freelancer-category-options" value="{{ request('category') }}" placeholder="Категория" class="min-h-12 rounded-2xl border border-slate-200 bg-white/85 px-4 text-sm outline-none focus:border-blue-300 focus:ring-4 focus:ring-blue-100">
                        <datalist id="freelancer-category-options">
                            @foreach($categories as $category)
                                <option value="{{ $category }}"></option>
                            @endforeach
                        </datalist>
                        <input name="city" value="{{ request('city') }}" placeholder="Град" class="min-h-12 rounded-2xl border border-slate-200 bg-white/85 px-4 text-sm outline-none focus:border-blue-300 focus:ring-4 focus:ring-blue-100">
                        ...
                        <select name="rating" class="min-h-12 rounded-2xl border border-slate-200 bg-white/85 px-4 text-sm outline-none focus:border-blue-300 focus:ring-4 focus:ring-blue-100">
                            <option value="">Рейтинг</option>
                            <option value="4.5" @selected(request('rating') === '4.5')>4.5+</option>
                            <option value="4" @selected(request('rating') === '4')>4.0+</option>
                        </select>
                        <select name="availability" class="min-h-12 rounded-2xl border border-slate-200 bg-white/85 px-4 text-sm outline-none focus:border-blue-300 focus:ring-4 focus:ring-blue-100">
                            <option value="">Наличност</option>
                            <option value="available" @selected(request('availability') === 'available')>Активни скоро</option>
                        </select>
                        <button class="min-h-12 rounded-2xl bg-slate-950 px-5 text-sm font-black text-white">Филтрирай</button>
                    </form>
                    ...
                    <div class="mt-7 grid gap-4 lg:grid-cols-3">
                        @forelse($freelancers as $freelancer)
                            ...
                            @endphp
                            <article class="rounded-[1.5rem] border border-white/70 bg-white/80 p-5 shadow-xl shadow-blue-900/5 backdrop-blur-2xl transition hover:-translate-y-1 hover:shadow-blue-900/10 sm:rounded-[2rem]">
                                    ...
                                    <div class="min-w-0">
                                        <div class="flex flex-wrap gap-2">
                                            @foreach(array_slice($trust['badges'] ?? [], 0, 2) as $badge)
                                                <span class="rounded-full bg-blue-50 px-2.5 py-1 text-[11px] font-black text-blue-700">{{ $badge }}</span>
                                            @endforeach
                                        </div>
                                        <h3 class="mt-2 text-xl font-black leading-tight">{{ $freelancer->name }}</h3>
                                        <p class="mt-1 text-sm font-bold text-violet-600">{{ $headline }}</p>
                                    </div>
                                </div>

                                <p class="mt-4 line-clamp-3 text-sm leading-6 text-slate-600">{{ $description }}</p>

                                <div class="mt-4 flex flex-wrap gap-2">
                                    @forelse($skills as $skill)
                                        <span class="rounded-full bg-slate-100 px-3 py-1 text-xs font-black text-slate-600">{{ $skill }}</span>
                                    @empty
                                        <span class="rounded-full bg-slate-100 px-3 py-1 text-xs font-black text-slate-600">Услуги по заявка</span>
                                    @endforelse
                                </div>

                                <div class="mt-5 grid gap-2 text-sm text-slate-600">
                                    <div class="flex justify-between gap-3 rounded-2xl bg-white/80 px-3 py-2">
                                ...
                                <div class="mt-5 grid gap-3 sm:grid-cols-2">
                                    ...
                                    <a href="{{ $freelancer->email ? 'mailto:' . $freelancer->email . '?subject=' . rawurlencode('Покана за проект през BON') : route('login') }}" onclick="window.trackBonEvent('contact_click', { source: 'freelancers_listing_invite', profile_id: '{{ $freelancer->id }}', profile_type: 'freelancer' })" class="inline-flex min-h-11 items-center justify-center rounded-2xl border border-slate-200 bg-white px-4 text-sm font-black text-slate-700 shadow-sm">
                                        Покани
                                    </a>
                                </div>
                            </article>
                        @empty
                            <div class="rounded-[1.5rem] border border-dashed border-blue-200 bg-blue-50/70 p-8 text-center lg:col-span-3">
                                <p class="text-2xl font-black">Бъди сред първите фрийлансъри в BON.</p>
