...
<head>
    <meta charset="UTF-8">
    <title>Получихме заявката ви във FixNow.bg</title>
</head>
    ...
    <div style="max-width:680px;margin:0 auto;padding:28px 18px;">
        <div style="background:#ffffff;border:1px solid #e2e8f0;border-radius:18px;padding:26px;">
            ...
            <p style="margin:0 0 18px;color:#475569;line-height:1.6;">
                Благодарим ви. Изпратихме заявката към {{ $serviceRequest->assignedBusiness?->business_name ?: $serviceRequest->assignedBusiness?->name ?: 'избрания изпълнител' }}. Изпълнителят ще се свърже с вас възможно най-скоро.
            </p>
