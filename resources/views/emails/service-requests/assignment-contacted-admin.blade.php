...
<head>
    <meta charset="UTF-8">
    <title>Бизнес се свърза с клиент във FixNow.bg</title>
</head>
<body style="margin:0;background:#f6f8fb;color:#0f172a;font-family:Arial,sans-serif;">
    <div style="max-width:680px;margin:0 auto;padding:28px 18px;">
        <div style="background:#ffffff;border:1px solid #e2e8f0;border-radius:18px;padding:26px;">
            ...
            <h1 style="margin:0 0 16px;font-size:26px;line-height:1.2;">Бизнес маркира “Свързах се с клиента”</h1>

            <p style="margin:0 0 18px;color:#475569;line-height:1.6;">
                <strong>{{ $business->business_name ?: $business->name }}</strong> маркира, че се е свързал с клиента по заявка #{{ $serviceRequest->id }}.
            </p>
            ...
            <table style="width:100%;border-collapse:collapse;margin:0 0 20px;">
                ...
                <tr><td style="padding:8px 0;color:#64748b;">Статус</td><td style="padding:8px 0;font-weight:700;">{{ $assignment->status }}</td></tr>
                @if($assignment->contacted_at)
                    <tr><td style="padding:8px 0;color:#64748b;">Свързал се</td><td style="padding:8px 0;font-weight:700;">{{ $assignment->contacted_at->format('d.m.Y H:i') }}</td></tr>
                @endif
            </table>

            <a href="{{ $dashboardUrl }}" style="display:inline-block;background:#2563eb;color:#ffffff;text-decoration:none;font-weight:700;border-radius:12px;padding:13px 18px;">Отвори admin dashboard</a>
        </div>
    </div>
</body>
</html>
