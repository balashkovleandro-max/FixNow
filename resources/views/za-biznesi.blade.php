...
<body class="fn-premium-page min-h-screen overflow-x-hidden pb-24 text-white md:pb-0">
    <div class="fixed inset-0 -z-10">
        <div class="absolute inset-0 bg-[radial-gradient(circle_at_16%_12%,rgba(251,146,60,0.20),transparent_30%),radial-gradient(circle_at_82%_16%,rgba(245,158,11,0.20),transparent_32%),linear-gradient(180deg,#030712_0%,#061426_52%,#020812_100%)]"></div>
...
<main>
        <section class="relative overflow-hidden">
            <div class="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_72%_24%,rgba(249,115,22,0.26),transparent_26%),radial-gradient(circle_at_88%_42%,rgba(245,158,11,0.20),transparent_28%)]"></div>
            <div class="mx-auto grid max-w-[1500px] gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_520px] lg:px-12 lg:py-20">
                <div class="max-w-4xl">
                    <p class="mb-5 inline-flex rounded-full border border-orange-300/20 bg-orange-300/10 px-4 py-2 text-sm font-black text-orange-100">За майстори, сервизи, салони, авто услуги и локални професионалисти</p>
                    ...
                    <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                        @guest
                            <a href="{{ route('register') }}" data-track="cta_business_signup" class="inline-flex items-center justify-center rounded-2xl bg-gradient-to-r from-orange-500 via-amber-400 to-orange-600 px-7 py-4 font-black text-white shadow-lg shadow-orange-600/25">Стани изпълнител</a>
                        @endguest
                        @auth
                            <a href="{{ route('dashboard') }}" class="inline-flex items-center justify-center rounded-2xl bg-gradient-to-r from-orange-500 via-amber-400 to-orange-600 px-7 py-4 font-black text-white shadow-lg shadow-orange-600/25">Към таблото</a>
                        @endauth
                        ...
                        <a href="{{ route('request.service') }}" data-track="cta_request" class="inline-flex items-center justify-center rounded-2xl border border-orange-300/20 bg-orange-300/10 px-7 py-4 font-black text-orange-100 hover:bg-orange-400/15">Виж как клиентите заявяват оферта</a>
                    </div>
                    ...
                    <div class="mt-10 grid gap-3 sm:grid-cols-3">
                        @foreach([
                            ...
                            <div class="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur-xl">
                                <p class="text-3xl font-black text-orange-300">{{ $stat['value'] }}</p>
                                <p class="mt-2 text-sm text-white/60">{{ $stat['label'] }}</p>
                            </div>
                        @endforeach
                    </div>

                    <div class="mt-6 rounded-[28px] border border-orange-300/20 bg-orange-300/10 p-5">
                        <p class="font-black text-orange-100">FixNow.bg стартира поетапно</p>
                ...
                <div class="rounded-[34px] border border-white/10 bg-white/10 p-5 shadow-2xl shadow-black/30 backdrop-blur-2xl">
                    <div class="rounded-[28px] border border-white/10 bg-slate-950/70 p-5">
                        <div class="h-48 rounded-3xl bg-gradient-to-br from-orange-500/20 via-amber-400/10 to-orange-600/25 p-5">
                        ...
                        <div class="-mt-10 px-2">
                            <div class="flex h-20 w-20 items-center justify-center rounded-3xl border-4 border-slate-950 bg-gradient-to-br from-orange-500 to-amber-400 text-3xl font-black">F</div>
        ...
        <section class="mx-auto max-w-[1500px] px-4 py-8 sm:px-6 lg:px-12">
            <div class="mb-6">
                <p class="text-sm font-black uppercase tracking-[0.24em] text-orange-200/80">Как работи</p>
            ...
            <div class="grid gap-4 md:grid-cols-3">
                @foreach([
                    ...
                    <div class="rounded-[30px] border border-white/10 bg-white/10 p-6 shadow-xl shadow-black/20 backdrop-blur-xl">
                        <p class="text-4xl font-black text-orange-300">{{ $item['step'] }}</p>
        ...
        <section class="mx-auto max-w-[1500px] px-4 py-8 sm:px-6 lg:px-12">
            <div class="grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
                <div>
                    <p class="text-sm font-black uppercase tracking-[0.24em] text-orange-200/80">Ползи</p>
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    @foreach([
                        ...
                        <div class="rounded-3xl border border-white/10 bg-white/10 p-5 shadow-xl shadow-black/20 backdrop-blur-xl">
                            <div class="mb-4 flex h-11 w-11 items-center justify-center rounded-2xl bg-orange-300/10 text-orange-100">✓</div>
        ...
        <section id="plans" class="mx-auto max-w-[1500px] px-4 py-8 sm:px-6 lg:px-12">
            <div class="mb-7 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    <p class="text-sm font-black uppercase tracking-[0.24em] text-orange-200/80">Планове</p>
            ...
            <div class="grid gap-5 lg:grid-cols-2">
                <div class="rounded-[32px] border border-white/10 bg-white/10 p-6 shadow-xl shadow-black/20 backdrop-blur-xl">
                    <p class="text-sm font-black uppercase tracking-[0.22em] text-orange-200/80">Standard</p>
                ...
                <div class="relative rounded-[32px] border border-orange-300/25 bg-gradient-to-br from-orange-500/16 via-amber-400/10 to-orange-400/12 p-6 shadow-2xl shadow-orange-950/25 backdrop-blur-xl">
                    <span class="absolute right-5 top-5 rounded-full bg-orange-400/20 px-3 py-1 text-xs font-black text-orange-100">Препоръчан</span>
                    <p class="text-sm font-black uppercase tracking-[0.22em] text-amber-200">Premium</p>
                    <div class="mt-4 flex items-end gap-2">
        ...
        <section class="mx-auto max-w-[1500px] px-4 py-8 sm:px-6 lg:px-12">
            <div class="grid gap-5 rounded-[34px] border border-orange-300/20 bg-gradient-to-br from-orange-500/12 via-amber-400/10 to-orange-600/15 p-6 shadow-xl shadow-orange-950/20 backdrop-blur-xl lg:grid-cols-[1fr_auto] lg:items-center sm:p-8">
                <div>
                    <p class="text-sm font-black uppercase tracking-[0.24em] text-orange-200/80">Lead generation</p>
                ...
                <a href="{{ route('request.service') }}" data-track="cta_request" class="rounded-2xl bg-gradient-to-r from-orange-500 via-amber-400 to-orange-600 px-7 py-4 text-center font-black text-white shadow-lg shadow-orange-600/25">Виж формата</a>
            </div>
        </section>

        <section class="mx-auto max-w-[1500px] px-4 py-8 sm:px-6 lg:px-12">
            <div class="rounded-[34px] border border-white/10 bg-white/10 p-6 shadow-xl shadow-black/20 backdrop-blur-xl sm:p-8">
                <p class="text-sm font-black uppercase tracking-[0.24em] text-orange-200/80">FAQ</p>
        ...
        <section class="mx-auto max-w-[1500px] px-4 py-10 sm:px-6 lg:px-12">
            <div class="overflow-hidden rounded-[34px] border border-white/10 bg-gradient-to-br from-orange-500/16 via-amber-400/12 to-orange-600/18 p-6 shadow-2xl shadow-black/25 backdrop-blur-xl sm:p-10">
                <div class="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                    <div>
                        <p class="text-sm font-black uppercase tracking-[0.24em] text-orange-100">Стартово предимство</p>
                    ...
                    @guest
                        <a href="{{ route('register') }}" data-track="cta_business_signup" class="inline-flex justify-center rounded-2xl bg-white px-7 py-4 font-black text-slate-950 hover:bg-orange-50">Стани изпълнител сега</a>
                    @endguest
                    @auth
                        <a href="{{ route('dashboard') }}" class="inline-flex justify-center rounded-2xl bg-white px-7 py-4 font-black text-slate-950 hover:bg-orange-50">Към таблото</a>
                    @endauth
                </div>
            </div>
        </section>
