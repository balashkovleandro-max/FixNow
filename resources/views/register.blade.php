...
<body class="antialiased">
    <main class="relative min-h-screen overflow-x-hidden bg-[#F8FAFF] text-[#070B1F]">
        ...
        <div class="relative z-10 flex min-h-screen flex-col px-4 py-4 sm:px-6 sm:py-5 lg:px-8">
            <header class="mx-auto flex w-full max-w-[1180px] items-center justify-between">
                ...
                <a href="{{ route('login') }}" class="rounded-2xl border border-slate-200/80 bg-white/70 px-4 py-2.5 text-sm font-bold text-[#070B1F] shadow-sm transition hover:-translate-y-0.5 hover:border-blue-200 hover:text-blue-600 sm:px-5 sm:py-3">
                    Вход
                </a>
            </header>

            <section class="mx-auto grid w-full max-w-[1180px] flex-1 items-center gap-8 py-8 sm:py-10 lg:grid-cols-[1fr_520px] lg:py-12">
                ...
                <section class="rounded-[1.65rem] border border-white/70 bg-white/75 p-2.5 shadow-[0_34px_100px_rgba(30,41,100,.11)] backdrop-blur-2xl sm:rounded-[2rem] sm:p-3">
                    <div class="rounded-[1.4rem] border border-white/70 bg-white/75 p-5 shadow-sm shadow-blue-900/5 sm:rounded-[1.65rem] sm:p-8">
                            ...
                            <div>
                                ...
                                <div class="grid gap-3 sm:grid-cols-3">
                                    <label class="group cursor-pointer">
                                        ...
                                        <span class="block rounded-3xl border border-slate-200/80 bg-white/75 p-4 shadow-sm shadow-blue-900/5 transition peer-checked:border-pink-300 peer-checked:bg-pink-50/70 peer-checked:ring-4 peer-checked:ring-pink-100 group-hover:-translate-y-0.5">
                                    ...
                                    <label class="group cursor-pointer">
                                        ...
                                        <span class="block rounded-3xl border border-slate-200/80 bg-white/75 p-4 shadow-sm shadow-blue-900/5 transition peer-checked:border-blue-300 peer-checked:bg-blue-50/70 peer-checked:ring-4 peer-checked:ring-blue-100 group-hover:-translate-y-0.5">
                                    ...
                                    <label class="group cursor-pointer">
                                        ...
                                        <span class="block rounded-3xl border border-slate-200/80 bg-white/75 p-4 shadow-sm shadow-blue-900/5 transition peer-checked:border-violet-300 peer-checked:bg-violet-50/70 peer-checked:ring-4 peer-checked:ring-violet-100 group-hover:-translate-y-0.5">
                        ...
                        <p class="mt-6 text-center text-sm text-slate-500">
                            Вече имаш акаунт?
                            <a href="{{ route('login') }}" class="font-black text-blue-600 hover:text-violet-600">Влез</a>
                        </p>
                    </div>
                </section>
            </section>
