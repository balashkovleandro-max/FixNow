...
<head>
    ...
    <meta name="description" content="Създай BON профил и започни от правилната стъпка — като бизнес или потребител.">
...
<body class="antialiased">
    <main class="relative min-h-screen overflow-x-hidden bg-[#F8FAFF] text-[#070B1F]">
        ...
        <div class="relative z-10 flex min-h-screen flex-col px-4 py-5 sm:px-6 lg:px-8">
            <header class="mx-auto flex w-full max-w-[1180px] items-center justify-between">
                ...
                <a href="{{ route('login') }}" class="rounded-2xl border border-slate-200/80 bg-white/70 px-5 py-3 text-sm font-bold text-[#070B1F] shadow-sm transition hover:-translate-y-0.5 hover:border-blue-200 hover:text-blue-600">
                    Вход
                </a>
            </header>

            <section class="mx-auto grid w-full max-w-[1180px] flex-1 items-center gap-8 py-10 lg:grid-cols-[1fr_520px] lg:py-12">
                ...
                <section class="rounded-[2rem] border border-white/70 bg-white/75 p-3 shadow-[0_34px_100px_rgba(30,41,100,.11)] backdrop-blur-2xl">
                    <div class="rounded-[1.65rem] border border-white/70 bg-white/75 p-6 shadow-sm shadow-blue-900/5 sm:p-8">
                        <div class="text-center sm:text-left">
                            <p class="text-sm font-black uppercase tracking-[0.22em] text-violet-600">Регистрация</p>
                            <h2 class="mt-3 text-3xl font-black tracking-tight text-[#070B1F]">Създай BON профил</h2>
                            <p class="mt-3 text-sm leading-6 text-slate-500">
                                Избери посока — бизнес или потребител — и започни от правилната стъпка.
                            </p>
                        </div>
                        ...
                        <form action="{{ route('register.post') }}" method="POST" class="mt-7 space-y-4">
                            ...
                            <div>
                                ...
                                <p class="mt-3 rounded-2xl border border-violet-100 bg-violet-50/70 px-4 py-3 text-xs font-semibold leading-5 text-violet-700">
                                    BON Talent Network кандидатстването ще бъде отделно.
                                </p>
