...
<body class="min-h-screen overflow-x-hidden bg-[#020812] pb-24 text-white md:pb-0">
    <div class="fixed inset-0 -z-10 bg-[radial-gradient(circle_at_18%_18%,rgba(34,211,238,0.18),transparent_28%),radial-gradient(circle_at_82%_8%,rgba(168,85,247,0.20),transparent_30%),linear-gradient(180deg,#030712_0%,#061426_52%,#020812_100%)]"></div>
    ...
    <main class="mx-auto grid min-h-[calc(100vh-80px)] max-w-7xl items-center gap-8 px-4 py-10 sm:px-6 lg:grid-cols-[1fr_500px] lg:px-8">
        <section class="hidden lg:block">
            <p class="mb-4 inline-flex rounded-full border border-violet-300/20 bg-violet-300/10 px-4 py-2 text-sm font-semibold text-violet-100">Създай профил</p>
            <h1 class="max-w-2xl text-5xl font-black leading-tight">
                Присъедини се към premium marketplace за
                <span class="bg-gradient-to-r from-cyan-300 via-blue-400 to-violet-500 bg-clip-text text-transparent">локални услуги</span>
            </h1>
            ...
            <div class="mt-8 grid max-w-xl grid-cols-3 gap-4">
                ...
                <div class="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur-xl">
                    <p class="text-2xl font-black text-blue-200">02</p>
                    <p class="mt-2 text-sm text-white/60">Добави данни</p>
                </div>
                <div class="rounded-3xl border border-white/10 bg-white/10 p-5 backdrop-blur-xl">
                    <p class="text-2xl font-black text-violet-200">03</p>
        ...
        <section class="rounded-[32px] border border-white/10 bg-white/10 p-3 shadow-2xl shadow-black/30 backdrop-blur-2xl">
            <div class="rounded-[26px] border border-white/10 bg-slate-950/70 p-6 sm:p-8">
                <p class="text-sm font-black uppercase tracking-[0.25em] text-cyan-200/80">Регистрация</p>
                ...
                <form action="{{ route('register.post') }}" method="POST" class="mt-7 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Твоето име" class="min-h-12 w-full rounded-2xl border border-white/10 bg-white/10 px-4 py-4 text-white outline-none placeholder:text-white/40 focus:border-cyan-300/50">
                    ...
                    <div>
                        ...
                        <select name="role" class="min-h-12 w-full rounded-2xl border border-white/10 bg-slate-950 px-4 py-4 text-white outline-none focus:border-cyan-300/50">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="password" name="password_confirmation" placeholder="Повтори паролата" class="min-h-12 w-full rounded-2xl border border-white/10 bg-white/10 px-4 py-4 text-white outline-none placeholder:text-white/40 focus:border-cyan-300/50">
                        </div>
                    </div>
                ...
                <p class="mt-6 text-center text-sm text-white/60">
                    Вече имаш профил?
                    <a href="{{ route('login') }}" class="font-bold text-cyan-200 hover:text-white">Влез</a>
                </p>
            </div>
        </section>
    </main>
