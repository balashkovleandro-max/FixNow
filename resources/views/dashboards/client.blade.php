...
<head>
    ...
    <title>Клиентски панел | FixNow.bg</title>
                            ...
                            <article class="rounded-3xl border border-white/10 bg-slate-950/55 p-5 shadow-lg shadow-black/20">
                                <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                                    ...
                                    <div class="rounded-2xl border border-white/10 bg-white/5 p-4 md:w-64">
                                        <p class="text-xs font-black uppercase tracking-[0.18em] text-white/40">Избран изпълнител</p>
                                        @if($selectedExecutor)
                                                ...
                                                <div class="rounded-2xl border border-white/10 bg-slate-950/60 p-4">
                                                    ...
                                                    @elseif($offer->status === 'accepted')
                                                        <p class="mt-4 rounded-2xl border border-emerald-300/25 bg-emerald-300/10 px-4 py-3 text-sm font-black text-emerald-100">
                                                            Приета оферта · Избран изпълнител
                                                        </p>
                                                    @endif
                                                </div>
                                            @endforeach
            ...
            <aside class="space-y-6">
                ...
                <div class="rounded-[32px] border border-cyan-300/20 bg-cyan-300/10 p-6 shadow-xl shadow-cyan-950/20 backdrop-blur-xl">
                    ...
                    <div class="mt-5 space-y-3 text-sm leading-6 text-white/70">
                        ...
                        <p>2. Подходящи изпълнители изпращат оферти.</p>
                        <p>3. Виждате историята и избрания изпълнител тук.</p>
                    </div>
                </div>
            </aside>
        </section>
