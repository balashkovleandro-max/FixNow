    ...
    <main class="relative min-h-screen overflow-x-hidden bg-[#F8FAFF] text-[#070B1F]">
        ...
        <div class="relative z-10 flex min-h-screen flex-col px-4 py-5 sm:px-6 lg:px-8">
            <header class="mx-auto flex w-full max-w-[1180px] items-center justify-between">
                ...
                <a href="{{ route('register') }}" class="rounded-2xl bg-gradient-to-r from-blue-600 via-violet-600 to-fuchsia-500 px-5 py-3 text-sm font-bold text-white shadow-xl shadow-violet-500/25 transition hover:-translate-y-0.5 hover:shadow-violet-500/35">
                    Регистрация
                </a>
            </header>

            <section class="mx-auto grid w-full max-w-[1180px] flex-1 items-center gap-8 py-10 lg:grid-cols-[1fr_460px] lg:py-12">
                ...
                <section class="rounded-[2rem] border border-white/70 bg-white/75 p-3 shadow-[0_34px_100px_rgba(30,41,100,.11)] backdrop-blur-2xl">
                    <div class="rounded-[1.65rem] border border-white/70 bg-white/75 p-6 shadow-sm shadow-blue-900/5 sm:p-8">
                        <div class="text-center sm:text-left">
                            ...
                            <h2 class="mt-3 text-3xl font-black tracking-tight text-[#070B1F]">Влез в BON</h2>
